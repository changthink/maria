...
<?php
//    $con=mysqli_connect("localhost", "root", "sunchang11", "rp") or die("MariaDB 접속 실패 !!");
   #$con=mysqli_connect("172.23.29.134:3306", "root", "sunchang11", "rp") or die("MariaDB 접속 실패 !!");   
   ...
   $sql ="SELECT 광역시도, 시자치구, 법정동, 아파트, 전용,
        ...
        GROUP BY 광역시도, 시자치구, 법정동, 아파트, 전용 LIMIT 200";

        $rst = mysqli_query($con, $sql);   
   
   echo "<h1> 분양권매매 실거래조회결과(1년) </h1>";  
   echo "<table border=1";
   echo "<TR>";   
